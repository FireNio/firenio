 ...
 *
 */
public class DefaultNoneLoadReadFutureAcceptor implements NoneLoadReadFutureAcceptor {

	private Logger logger = LoggerFactory.getLogger(getClass());
	
	@Override
	public void accept(BalanceFacadeSocketSession session, BalanceReadFuture future,
