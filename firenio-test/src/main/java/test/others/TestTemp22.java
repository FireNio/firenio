...
public class TestTemp22 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileUtil.scanDirectory(new File("D:/工作仓库/SVN/1_CODE/goldtrade-common/src/main/java/com/brilliance/goldtrade/common/stand/model"), new OnDirectoryScan() {
            ...
            public void onFile(File file) throws Exception {
                ...
                String newContent = content.substring(0, index + 1) + append + content.substring(index + 1);
