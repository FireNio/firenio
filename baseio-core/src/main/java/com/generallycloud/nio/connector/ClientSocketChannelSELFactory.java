 ...
 *
 */
public class ClientSocketChannelSELFactory extends AbstractSelectorEventLoopFactory {

	public ClientSocketChannelSELFactory(ChannelService channelService) {
	...
	protected SelectorEventLoop newEventLoop(ChannelService channelService, SelectorEventLoop[] selectorEventLoops,
			int eventQueueSize) {
		return new ClientSocketChannelSelectorLoop((SocketChannelConnector) channelService, selectorEventLoops);
	}
