...
public class JdkSslContext extends SslContext {
	 ...
	 *             Secure Socket Extension Reference Guide for information
	 ...
	 *             The existing {@link KeyManagerFactory} that will be used if
	 *             not {@code null}
	 * @return A {@link KeyManagerFactory} based upon a key algorithm, key
	 *         file, key file password, and a certificate chain.
	 * @deprecated will be removed.
	 */
	@Deprecated
	protected static KeyManagerFactory buildKeyManagerFactory(File certChainFile, String keyAlgorithm, File keyFile,
			String keyPassword, KeyManagerFactory kmf) throws KeyStoreException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, IOException,
