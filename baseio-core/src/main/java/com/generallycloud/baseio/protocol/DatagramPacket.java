...
public class DatagramPacket{
	...
	public String getDataString(Charset encoding) {
		if (dataString == null) {
			dataString = new String(getData(),getOffset(), getData().length - getOffset() , encoding);
		}
		return dataString;
	}
	...
	public static DatagramPacket createSendPacket(int type ,long timestamp, int sequenceNo, byte[] data){
