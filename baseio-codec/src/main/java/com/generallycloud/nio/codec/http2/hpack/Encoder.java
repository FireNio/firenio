...
//            }
     ...
     */
    private void encodeLiteral(ByteBuf out, String name, String value, HpackUtil.IndexType indexType,
                               int nameIndex) {
    ...
    private HeaderEntry getEntry(String name, String value) {
        ...
        for (HeaderEntry e = headerFields[i]; e != null; e = e.next) {
            ...
            if (e.hash == h && (equalsConstantTime(name, e.getName()) & equalsConstantTime(value, e.getValue())) != 0) {
                return e;
            }
        }
        return null;
