...
import static com.generallycloud.nio.codec.http2.hpack.HpackUtil.equalsConstantTime;
import static com.generallycloud.nio.codec.http2.hpack.HpackUtil.IndexType.INCREMENTAL;
import static com.generallycloud.nio.codec.http2.hpack.HpackUtil.IndexType.NEVER;
import static com.generallycloud.nio.codec.http2.hpack.HpackUtil.IndexType.NONE;
...
import static com.generallycloud.nio.common.MathUtil.findNextPositivePowerOfTwo;
...
import com.generallycloud.nio.codec.http2.hpack.Http2HeadersEncoder.SensitivityDetector;
...
public final class Encoder {
	 ...
	 * <strong>The given {@link String}s must be immutable!</strong>
	 */
	private void encodeHeader(ByteBuf out, String name, String value, boolean sensitive, long headerSize) {
	 ...
	 */
	private void encodeLiteral(ByteBuf out, String name, String value, HpackUtil.IndexType indexType, int nameIndex) {
	...
	private HeaderEntry getEntry(String name, String value) {
		...
		for (HeaderEntry e = headerFields[i]; e != null; e = e.next) {
			...
			if (e.hash == h
					&& (equalsConstantTime(name, e.getName()) & equalsConstantTime(value, e.getValue())) != 0) {
				return e;
			}
		}
		return null;
