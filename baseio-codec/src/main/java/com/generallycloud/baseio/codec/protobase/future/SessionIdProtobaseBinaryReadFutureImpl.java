 ...
 *
 */
public class SessionIdProtobaseBinaryReadFutureImpl extends ProtobaseBinaryReadFutureImpl
		implements SessionIdProtobaseReadFuture {

	public SessionIdProtobaseBinaryReadFutureImpl(SocketChannelContext context) {
		super(context);
	}

	public SessionIdProtobaseBinaryReadFutureImpl(SocketSession session, ByteBuf buf,
