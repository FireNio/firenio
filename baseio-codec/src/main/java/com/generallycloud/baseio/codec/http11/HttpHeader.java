...
public final class HttpHeader {
    ...
    public static final String Low_Sec_WebSocket_Accept = "sec-websocket-accept";
    ...
    public static final byte[]              Sec_WebSocket_Accept_Bytes = Sec_WebSocket_Accept
            .getBytes();
    //表明客户端请求实体应该使用的授权方案  WWW-Authenticate: Basic
    public static final String              WWW_Authenticate           = "WWW-Authenticate";
    public static final byte[]              WWW_Authenticate_Bytes     = WWW_Authenticate
            .getBytes();
