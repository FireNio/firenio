...
public enum Http2FrameType {
    ...
    FRAME_TYPE_CONTINUATION(0x09), FRAME_TYPE_DATA(0x00), FRAME_TYPE_GOAWAY(0x07), FRAME_TYPE_HEADERS(0x01), FRAME_TYPE_PING(0x06), FRAME_TYPE_PRIORITY(0x02), FRAME_TYPE_PUSH_PROMISE(0x05), FRAME_TYPE_RST_STREAM(0x03), FRAME_TYPE_SETTINGS(0x04), FRAME_TYPE_WINDOW_UPDATE(0x08);
