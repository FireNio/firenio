...
public final class FutureAcceptorFilter extends AbstractFutureAcceptor {

	private DynamicClassLoader			classLoader			= null;
	private Logger						logger				= LoggerFactory.getLogger(FutureAcceptorFilter.class);
	private FutureAcceptorServiceLoader	acceptorServiceLoader	= null;

	public FutureAcceptorFilter(DynamicClassLoader classLoader) {
	...
	public void initialize(ApplicationContext context, Configuration config) throws Exception {
		...
		this.acceptorServiceLoader = new NormalFutureAcceptorLoader(context, classLoader);
