$(function() {
    ...
    var COLORS = [ '#e21400', '#91580f', '#f8a700', '#f78b00', '#58dc00', '#287b00', '#a8f07a', '#4ae8c4', '#3b88eb',
    ...
    function initWebSocket(socket) {
        ...
        socket.onmessage = function(e) {
            ...
            if ("new-message" == action) {
                ...
                var message = "Welcome to firenio Chat – ";
                log(message, {
                    prepend : true
                });
    ...
    function addChatMessage(data, options) {
        ...
        var $usernameDiv = $('<span class="username"/>').text(data.username).css('color',
                getUsernameColor(data.username));
        var $messageBodyDiv = $('<span class="messageBody">').text(data.message);

        var typingClass = data.typing ? 'typing' : '';
        var $messageDiv = $('<li class="message"/>').data('username', data.username).addClass(typingClass).append(
